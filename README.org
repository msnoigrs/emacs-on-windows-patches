...
* GNU Emacs 30.2(あるいは31.0.50)をWindows向けにMinGW(MSYS2)でコンパイルして使う人のためのパッチ - W32-IME組み込み
...
IMEやcmigemoに関するパッチは、以下の情報由来のものです。Emacs 30.2や31.0.50のソースに適用できるように作成してあります。
...
** 00-emacs-30.2-w32-ime.patch, 00-emacs-20250829-w32-ime.patch
...
** 01-emacs-30.2-disable-w32-ime.patch, 01-emacs-20250829-disable-w32-ime.patch
