...
* GNU Emacs 29.1.xをWindows向けにMinGW(MSYS2)でコンパイルして使う人のためのパッチ - W32-IME組み込み
...
IMEやcmigemoに関するパッチは、以下の情報由来のものです。Emacs 29.1.90のソースに適用できるように作成してあります。
...
** 00-emacs-29.1.90-w32-ime.patch
...
** 01-emacs-29.1.90-disable-w32-ime.patch
...
** 04-emacs-29.1.90-mingw32-remove-check.patch
