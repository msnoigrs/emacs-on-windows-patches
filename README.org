...
* GNU Emacs 26.1をWindows向けにMinGW(MSYS2)でコンパイルして使う人のためのパッチ

このリポジトリに含まれるパッチは、以下の二つの情報由来のものです。Emacs 26.1のソースに適用できるように作成してあります。
...
** 01-emacs-26.1-disable-w32-ime.patch
...
** 02-emacs-26.1-dontusereg.patch
