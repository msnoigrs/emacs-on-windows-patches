...
#+BEGIN_EXAMPLE
$ patch -p1 < ../emacs-on-windows-patches/00-emacs-29.1.90-w32-ime.patch
$ patch -p1 < ../emacs-on-windows-patches/01-emacs-29.1.90-disable-w32-ime.patch
$ patch -p1 < ../emacs-on-windows-patches/02-emacs-29.1.90-dontusereg.patch
$ patch -p1 < ../emacs-on-windows-patches/03-emacs-29.1.90-cmigemo.patch
$ patch -p1 < ../emacs-on-windows-patches/04-emacs-29.1.90-mingw32-remove-check.patch
#+END_EXAMPLE
