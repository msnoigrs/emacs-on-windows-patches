...
$ cd ../emacs-emacs-29.4
$ ./autogen.sh
$ CFLAGS='-O2 -march=x86-64 -mtune=corei7 -static -s -g0 -Wp,-D_FORTIFY_SOURCE=2 -fno-optimize-sibling-calls -I/usr/local/include' LDFLAGS='-s' ./configure --host="x86_64-w64-mingw32" --build="x86_64-w64-mingw32" --with-native-compilation=aot --with-gnutls --with-imagemagick --with-jpeg --with-png --with-rsvg --with-tiff --with-wide-int --with-xft --with-xml2 --with-xpm --without-dbus --without-pop --without-compress-install --with-modules --with-tree-sitter --with-cmigemo
$ make actual-all
