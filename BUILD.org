...
#+BEGIN_EXAMPLE
$ git clone -b emacs-28 https://github.com/emacs-mirror/emacs
#+END_EXAMPLE
...
#+BEGIN_EXAMPLE
$ patch -p1 < ../emacs-on-windows-patches/00-emacs-28-w32-ime.patch
$ patch -p1 < ../emacs-on-windows-patches/01-emacs-28-disable-w32-ime.patch
$ patch -p1 < ../emacs-on-windows-patches/02-emacs-28-dontusereg.patch
$ patch -p1 < ../emacs-on-windows-patches/03-emacs-28-cmigemo.patch
$ patch -p1 < ../emacs-on-windows-patches/04-emacs-28-mingw32-remove-check.patch
#+END_EXAMPLE
